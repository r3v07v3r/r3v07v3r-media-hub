...
const LOCALISED_RELEASE_TOKENS: Record<string, string> = {
  french: 'fr', truefrench: 'fr', vff: 'fr', vfq: 'fr', vfi: 'fr', vostfr: 'fr', subfrench: 'fr',
...
const LANGUAGE_NAMES: Record<string, string> = {
  ...
  ko: 'Korean', zh: 'Chinese', hi: 'Hindi', ar: 'Arabic', sv: 'Swedish',
  da: 'Danish', no: 'Norwegian', fi: 'Finnish', cs: 'Czech', el: 'Greek',
  he: 'Hebrew', tr: 'Turkish', th: 'Thai', uk: 'Ukrainian', hu: 'Hungarian',
  ro: 'Romanian'
}
...
export const SELECTABLE_LANGUAGES: readonly string[] = [
  ...
  'hi', 'ar', 'sv', 'da', 'no', 'fi', 'cs', 'el', 'he', 'tr', 'th', 'uk',
  'hu', 'ro'
]
